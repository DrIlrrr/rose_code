function write_initial_for_cain_OLD(turn_number)
global  home_dir DIRECTORY_FOR_CAIN;
global rflags
tilted_name = 'newbeam_tmp';


angle=0; %initial scattered angle [rad]
pulseE=1; %laser puse energy [J]
shifting_laser_x = 0;  %
shifting_laser_y = 0;  %
shifting_laser_s = 0;  %
...
% header
% fprintf(fileID,' ALLOCATE  MP=10000000;\n');
...
fprintf(fileID,' SET wl=532*nm, pulseE=%f, wlbar=wl/(2*Pi),\n',pulseE);
fprintf(fileID,'! LASER pulse energy 1 J \n');
fprintf(fileID,'   eph=Hbarc/wlbar,   !  laser photon energy in eV\n');
fprintf(fileID,'   sigLr1=30*micron/2.0, sigLr2=30*micron/2.0,  rayl1=2/wlbar*sigLr1^2, rayl2=2/wlbar*sigLr2^2, ! Waist is 2sigLr  \n');
fprintf(fileID,'   sigt=5*psec,\n');
fprintf(fileID,'   angle=%f , tdl=1.0,\n',angle);
fprintf(fileID,'   p0=pulseE*Cvel/[Pi*wlbar*sigt*Sqrt(2*Pi*rayl1*rayl2*tdl^2)],\n');
...
fprintf(fileID,'PRINT rayl1, FORMAT=("ZRai1l =",F10.5);\n');
...
fprintf(fileID,' RAYLEIGH=(rayl1,rayl2),GCUTT=5;\n');
