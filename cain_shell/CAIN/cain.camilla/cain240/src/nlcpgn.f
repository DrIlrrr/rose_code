!       Begin Change by Li Dongguo March.11.2003 
      SUBROUTINE NLCPGN(PE1,WL,EV,HE1,STOKESL,PD,DT,PMAX,ISPIN1,
...
!      SUBROUTINE NLCPGN(PE1,WL,NL,HE1,HL,PD,DT,PMAX,ISPIN1,
...
!     %    NPH,PE2,HE2,PG,HG,PROB,WGT,IRTN)
 ...
 !      End Add, March.12.2003(by Li Dongguo)      
      EEFF=E1+XI2/LAM*WL
      CALL NLCPGN0(XI,LAM,DT,EEFF,HL,HE1,PMAX,ISPIN1,
     %     NPH,XG,HE2,HG,
...
C
 900  IRTN=1000
      WRITE(MSGFL,905)
 905  FORMAT(' (SUBR.NLCPGN) SUBR.NLCPST has not yet been called.')
      RETURN
      END
