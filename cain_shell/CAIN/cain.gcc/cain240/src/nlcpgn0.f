      SUBROUTINE NLCPGN0(XI,LAM,DT,EEFF,HL,HEI,PMAX,ISPIN1,
...
C        sum of FF0 and FF1 must be 2
 ...
 905  FORMAT(' (SUBR.NLCPGN0) Xi out of range. Xi^2=',1PD11.4)
      RETURN
 910  IRTN=1002
      WRITE(MSGFL,915) LAM
 915  FORMAT(' (SUBR.NLCPGN0) Lambda out of range. Lambda=',1PD11.4)
      RETURN
 920  IRTN=100
c      WRITE(MSGFL,925)
c 925  FORMAT(' (SUBR.NLCPGN0) Radiation rate too large.')
      RETURN
      END
