function all_in_on_function(out_folder,turn_number)

close all;

%out_folder=['new_5000_const_em_1'];

mkdir([ out_folder 'photon_data_plots'])
...
fid = fopen([out_folder 'photon_data_plots/photons_data.dat'],'w');%save beam for cain standart
