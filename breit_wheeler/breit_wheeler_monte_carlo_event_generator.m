function [cos_alpha,cos_theta,theta_3,theta_4,phi_3,phi_4,E_3,E_4,Vq,Ecm_pair,gamma_cm]=breit_wheeler_monte_carlo_event_generator(E_1,Px_1,Py_1,Pz_1,Sx_1,Sy_1,Sz_1,E_2,Px_2,Py_2,Pz_2,Sx_2,Sy_2,Sz_2)
global ev cs cross
...
m_1=0;
m_2=0;
m_3=0.511e6;% electron rest mass [eV]
m_4=0.511e6;% positron rest mass
...
[cos_theta,Vq]=rejection_method_breit_wheeler(Ecm_pair);
