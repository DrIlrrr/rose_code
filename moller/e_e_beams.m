function [beam_1,beam_2]=e_e_beams(L)
global rflags gvar
...
beam_1i=dlmread([pwd '/moller/' num2str(gvar.energy) 'MeVcain_output_electrons.dat'],'',0,0);%read electrons from cain
beam_2i=dlmread([pwd '/moller/' num2str(gvar.energy) 'MeVcain_output_electrons.dat'],'',0,0);%read photons from cain
