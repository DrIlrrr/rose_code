...
beam_1i=dlmread([pwd '/e_gammas_beams_low_stat/260MeVcain_output_electrons.dat'],'',0,0);%read electrons from cain
beam_2i=dlmread([pwd '/e_gammas_beams_low_stat/260MeVphotons_data.dat'],'',0,0);%read photons from cain
